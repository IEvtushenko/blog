    ...
    <div class="col-full page-conainer">
        <div class="wrap-col">
            <div class="post-margin">
                ...
                <p>В целях тренировки, были использованны, генераторы, исключения, различные библиотеки, pagination, TWIG, monolog, unit:timer.</p>
                <p>В планах, дальнейшая доработка проекта, а именно:</p>
                <ul>
                    <li>Доработать обрезание картинок под необходимые размеры.</li>
